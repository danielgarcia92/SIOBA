    ...
    auth2.attachClickHandler(element, {},
        function(googleUser) {
            ...
            var listaGuardarIngreso = {
                ...
                'correoCalificador' : perfil.getEmail(),
                'idToken'           : googleUser.Zi.id_token,
                'accessToken'       : googleUser.Zi.access_token
            };
            $.ajax({
                type        : 'post',
                url         : 'LoginCalificador/guardarIngreso',
                ...
                if (datos.exito) {
                    ...
                    .done(function(data){
                        ...
                        setTimeout(function(){
                            ...
                            form.attr('action', 'Calificador');
                            
                            input = $('<input />');
                            input.attr('type', 'hidden');
                            input.attr('name', 'correoCalificador');
                            input.attr('value', perfil.getEmail());
                            input.appendTo(form);
